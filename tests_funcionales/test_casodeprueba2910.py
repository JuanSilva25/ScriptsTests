...
class TestCasodeprueba2910():
  ...
  def test_casodeprueba2910(self):
    ...
    self.driver.find_element(By.ID, "usersName").send_keys("Juan123")
    self.driver.find_element(By.ID, "userNewForm").click()
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").send_keys("juan2.silva@correounivalle.edu.co")
    ...
    assert self.driver.find_element(By.ID, "notify_message").text == "The field must not contain numbers"
