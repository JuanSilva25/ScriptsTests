...
class TestCasodeprueba2911():
  ...
  def test_casodeprueba2911(self):
    ...
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").click()
    self.driver.find_element(By.ID, "userEmail").send_keys("juan.silva7@correounivalle.edu.co")
    ...
    assert self.driver.find_element(By.ID, "notify_message").text == "The field must not contain special characters"
