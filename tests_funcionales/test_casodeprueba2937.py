...
class TestCasodeprueba2937():
  ...
  def test_casodeprueba2937(self):
    ...
    self.driver.find_element(By.ID, "userEmail").send_keys("ivan@gmail.com")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".has-error > .form-control").send_keys("321")
