...
class TestCasodeprueba2920():
  ...
  def test_casodeprueba2920(self):
    ...
    self.driver.find_element(By.ID, "userEmail").send_keys("!!!juan#silva__@correounivalle.edu.co")
    ...
    assert self.driver.find_element(By.ID, "notify_message").text == "Failed to create user. Check inputs."
    self.driver.close()
