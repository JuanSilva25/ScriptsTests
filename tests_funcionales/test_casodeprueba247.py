...
class TestCasodeprueba247():
  ...
  def test_casodeprueba247(self):
    ...
    self.driver.find_element(By.ID, "product_quantity").send_keys("11")
    self.driver.find_element(By.CSS_SELECTOR, "#container > .row").click()
    self.driver.find_element(By.CSS_SELECTOR, ".btn-block").click()
    assert self.driver.find_element(By.ID, "notify_message").text == "Maximum amount reached."
    self.driver.close()
