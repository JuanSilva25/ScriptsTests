...
class TestCasodeprueba423():
  ...
  def test_casodeprueba423(self):
    ...
    self.driver.find_element(By.ID, "pageName").send_keys("Mi-@!!Página-1")
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".note-insert > .note-btn:nth-child(2)")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    element = self.driver.find_element(By.CSS_SELECTOR, "body")
    actions = ActionChains(self.driver)
