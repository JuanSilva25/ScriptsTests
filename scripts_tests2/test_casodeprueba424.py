...
class TestCasodeprueba474():
  ...
  def test_casodeprueba474(self):
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".note-insert > .note-btn:nth-child(3)")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    element = self.driver.find_element(By.CSS_SELECTOR, "body")
    actions = ActionChains(self.driver)
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".note-icon-caret:nth-child(1)")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    element = self.driver.find_element(By.CSS_SELECTOR, "body")
    actions = ActionChains(self.driver)
