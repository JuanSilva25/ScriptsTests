...
class TestCasodeprueba421():
  ...
  def test_casodeprueba421(self):
    ...
    self.driver.find_element(By.ID, "pageName").send_keys("\"Mi Página\"")
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".note-icon-magic")
    ...
    actions = ActionChains(self.driver)
    actions.move_to_element(element, 0, 0).perform()
    assert self.driver.find_element(By.ID, "notify_message").text == "New page successfully created"
