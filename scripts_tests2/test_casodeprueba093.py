...
class TestCasodeprueba094():
  ...
  def test_casodeprueba094(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#menuId-0 > .col-sm-2 > .form-control").click()
    element = self.driver.find_element(By.CSS_SELECTOR, "#menuId-0 > .col-sm-2 > .form-control")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.find_element(By.CSS_SELECTOR, "#menuId-2 > .col-sm-2 > .form-control").click()
    self.driver.find_element(By.CSS_SELECTOR, "#menuId-2 > .col-sm-2 > .form-control").send_keys("Hombre")
